...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated', #Indicamos que daremos permiso solo a los autenticados
    ],
    #Indicamos que usaremos nuestro propio manejador de exepciones personalizado de manera global
    'EXCEPTION_HANDLER': 'api.exceptions.custom_exception_handler',
}

#Le indicamos a Django que usaremos su modelo de USER para nuestro modelo de usuario
